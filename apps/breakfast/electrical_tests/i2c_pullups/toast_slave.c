...
void USCIAB0TX_ISR(void) __attribute((wakeup)) __attribute((interrupt(USCIAB0TX_VECTOR))); 

__attribute((wakeup)) __attribute((interrupt(USCIAB0TX_VECTOR))) void USCIAB0TX_ISR(void) 
{
...
void USCIAB0RX_ISR(void) __attribute((wakeup)) __attribute((interrupt(USCIAB0RX_VECTOR)));

__attribute((wakeup)) __attribute((interrupt(USCIAB0RX_VECTOR))) void USCIAB0RX_ISR(void) 
{
