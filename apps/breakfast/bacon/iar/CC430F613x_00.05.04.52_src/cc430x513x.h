...
#define CBREF0_0            (0x0000)  /* Comp. B Int. Ref.0 Select 0 : Off */
#define CBREF0_1            (0x0001)  /* Comp. B Int. Ref.0 Select 1 : 0.25*Vcc */
#define CBREF0_2            (0x0002)  /* Comp. B Int. Ref.0 Select 2 : 0.5*Vcc */
#define CBREF0_3            (0x0003)  /* Comp. B Int. Ref.0 Select 3 : Vt*/
#define CBREF0_4            (0x0004)  /* Comp. B Int. Ref.0 Select 4 : Hysteresis */
#define CBREF0_5            (0x0005)  /* Comp. B Int. Ref.0 Select 5 : Reserved */
#define CBREF0_6            (0x0006)  /* Comp. B Int. Ref.0 Select 6 : Reserved */
#define CBREF0_7            (0x0007)  /* Comp. B Int. Ref.0 Select 7 : Reserved */
...
#define CBREF1_0            (0x0000)  /* Comp. B Int. Ref.1 Select 0 : Off */
#define CBREF1_1            (0x0100)  /* Comp. B Int. Ref.1 Select 1 : 0.25*Vcc */
#define CBREF1_2            (0x0200)  /* Comp. B Int. Ref.1 Select 2 : 0.5*Vcc */
#define CBREF1_3            (0x0300)  /* Comp. B Int. Ref.1 Select 3 : Vt*/
#define CBREF1_4            (0x0400)  /* Comp. B Int. Ref.1 Select 4 : Hysteresis */
#define CBREF1_5            (0x0500)  /* Comp. B Int. Ref.1 Select 5 : Reserved */
#define CBREF1_6            (0x0600)  /* Comp. B Int. Ref.1 Select 6 : Reserved */
#define CBREF1_7            (0x0700)  /* Comp. B Int. Ref.1 Select 7 : Reserved */
...
#define RTC_A_VECTOR        (46 * 2u) /* 0xFFDC RTC */
